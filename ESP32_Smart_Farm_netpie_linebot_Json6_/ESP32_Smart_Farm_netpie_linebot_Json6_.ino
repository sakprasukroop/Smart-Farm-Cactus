...
const char* ssid     = "Sak1694";         //change this to your SSID
...
//NETPIE-Info
#define APPID       "SmartFarmCactus"             //Same data at Line#3 of pub.php
#define KEY         "T7olk2QoSK84NsE"            //Same data at Line#4 of pub.php
#define SECRET      "l8jeeYtqRKkg6xzd5gklLp5wO"  //Same data at Line#5 of pub.php
